...
/****** Object:  StoredProcedure [dbo].[AddOrUpdateTeamMembers]    Script Date: 02-12-2024 21:35:40 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    -- Step 7: Print row count for debugging
    PRINT 'Inserted Row Count: ' + CAST(@@ROWCOUNT AS NVARCHAR(10));
