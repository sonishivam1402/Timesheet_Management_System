...
/****** Object:  UserDefinedFunction [dbo].[GetTimeSheetDuration]    Script Date: 02-12-2024 21:40:52 ******/
SET ANSI_NULLS ON
GO
...
CREATE function [dbo].[GetTimeSheetDuration](@StartDate datetime,@EndDate datetime)
returns varchar(100)
as
Begin
